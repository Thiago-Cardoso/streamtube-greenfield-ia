...
description: "Testing guide for nestjs-project. Covers what to test, at which layer, and how to set up each test — organized by artifact type.\nTRIGGER when: planning nestjs-project features, implementing nestjs-project features, writing tests for nestjs-project, reviewing nestjs-project code, reviewing nestjs-project tests, what should I test in nestjs-project, how to test nestjs-project, nestjs-project test guide.\nDO NOT TRIGGER when: only reading nestjs-project code without intent to modify, working on frontend, or asking general TypeScript questions."
---
